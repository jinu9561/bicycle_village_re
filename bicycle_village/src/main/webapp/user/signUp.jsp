        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="../index.html" class="js-logo-clone">자전거 마을</a>
              </div>
            </div>
...
<c:when test="${empty loginUser || UserStatus!=0}">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="../index.html">Home</a> <span class="mx-2 mb-0">/</span> <!-- <a href="cart.html">Cart</a> <span class="mx-2 mb-0">/</span> --> <strong class="text-black">회원가입</strong></div>
        </div>
      </div>
    </div>
